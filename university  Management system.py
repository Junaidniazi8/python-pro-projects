...
class uni():
    def __init__(self,root):
        ...
        rnLbl = tk.Label(inFrame,text="Roll No:",bg=self.clr(180,150,220),fg="white",font=("Arial",15,"bold"))
    ...
    def dbFun(self):
         self.con = pymysql.connect(host="localhost", user="root", passwd="12345678", database="universitymanagement")
